...
def bind_kv_cache(
    ...
    runner_ssd_kv_caches: Optional[list[torch.Tensor]],
) -> None:
    """
    ...
    for layer_index in sorted(index2name.keys()):
        ...
        if ssd_kv_caches is not None and runner_ssd_kv_caches is not None:
            runner_ssd_kv_caches.append(ssd_kv_caches[layer_name])
